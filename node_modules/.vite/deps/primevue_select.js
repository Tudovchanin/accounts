import {
  FilterService,
  PrimeVueService
} from "./chunk-L5HHKYFR.js";
import {
  ConnectedOverlayScrollHandler,
  OverlayEventBus,
  script as script4,
  script2 as script5
} from "./chunk-NAKZSJJJ.js";
import {
  Base,
  script,
  script2,
  script3
} from "./chunk-EETGKFHN.js";
import {
  BaseStyle,
  ZIndex,
  absolutePosition,
...
var BaseDirective = {
  ...
  _extend: function _extend(name) {
    ...
    var handleHook = function handleHook2(hook, el, binding, vnode, prevVnode) {
      ...
      var $options = isEmpty($prevInstance) ? _objectSpread(_objectSpread({}, options2), options2 === null || options2 === void 0 ? void 0 : options2.methods) : {};
...
var script15 = {
  ...
  computed: {
      ...
      if (this.filterValue) {
        ...
        if (this.optionGroupLabel) {
          ...
          optionGroups.forEach(function(group) {
            ...
            if (filteredItems.length > 0) filtered.push(_objectSpread3(_objectSpread3({}, group), {}, _defineProperty4({}, typeof _this19.optionGroupChildren === "string" ? _this19.optionGroupChildren : "items", _toConsumableArray2(filteredItems))));
          });
    ...
    dropdownIconDataP: function dropdownIconDataP() {
      return cn(_defineProperty4({}, this.size, this.size));
    },
    overlayDataP: function overlayDataP() {
      return cn(_defineProperty4({}, "portal-" + this.appendTo, "portal-" + this.appendTo));
    }
  },
  directives: {
    ripple: Ripple
